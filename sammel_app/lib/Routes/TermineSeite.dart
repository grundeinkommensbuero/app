...
class _TermineSeiteState extends State<TermineSeite> {
        ...
        child: Column(children: [
          Text('Termin',
              style: TextStyle(
                  ...
                  color: Colors.deepPurpleAccent)),
          Text(
              'am ${formatiereDatum(termin.beginn)***REMOVED*** von ${formatiereZeit(termin.beginn)***REMOVED*** bis ${formatiereZeit(termin.ende)***REMOVED***'),
          Row(
            children: <Widget>[
              Text('Ort: ', style: style),
              Text('${termin.ort.bezirk***REMOVED***, ${termin.ort.ort***REMOVED***', style: style)
            ],
          ),
          Column(
  ...
  ***REMOVED***
  ...
  String formatiereZeit(DateTime datetime) {
    return '${datetime.hour***REMOVED***:${datetime.minute***REMOVED***';
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  String formatiereDatum(DateTime datetime) =>
      '${wochentag(datetime)***REMOVED***, ${datetime.day***REMOVED***.${datetime.month***REMOVED***';
