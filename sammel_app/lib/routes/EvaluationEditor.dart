...
class EvaluationEditor extends StatefulWidget {
  ...
  EvaluationEditor({this.onFinish, Key key, this.terminId}) : super(key: key) {
    if (onFinish == null) onFinish = (Evaluation _) {}; // TODO unclear if this is necessary or what it does, presumably it passes a default function that does nothing
  }
