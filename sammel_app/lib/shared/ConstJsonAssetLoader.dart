...
const Map<String, dynamic> en = {
  ...
  ***REMOVED***,
  ...
  "Dein Feedback zu einer Aktion fehlt noch": "We're missing your feedback for an action",
...
const Map<String, dynamic> fr = {
  ...
  "Workshop": "Workshop",
  "Unbekannter Nachrichtentyp abgespeichert": "Message de type inconnu sauvegardé",
  "{kiez***REMOVED*** in {bezirk***REMOVED***\n Treffpunkt: {treffpunkt***REMOVED***": "{kiez***REMOVED*** dans {bezirk***REMOVED***\n Point de rencontre: {treffpunkt***REMOVED***",
  "Unlesbare Push-Nachricht (Teilnahme) empfangen: {message***REMOVED***": "Notification push illisible (Participation) reçue: {message***REMOVED***",
  ...
  ***REMOVED***,
  ...
  "Wähle auf der Karte einen Treffpunkt aus.": "Choisis un point de rencontre sur la carte.",
  "Du kannst eine eigene Beschreibung angeben, z.B. \"Unter der Weltzeituhr\" oder \"Tempelhofer Feld, Eingang Kienitzstraße\":": "Tu peux donner ta propre déscription, ex. \"Sous l'horloge universelle\" ou \"Tempelhofer Feld, 'Entrée Kienitzstraße\"",
  "Abbrechen": "Quitter",
  "Aktionen": "Actions",
  "Aktionen in einer Liste oder Karte anschauen": "Voir actions sur une liste ou une carte",
  ...
  "Tipps, Tricks und Argumentationshilfen": "Conseils, tuyaux, aide à l'argumentation",
  "Profil": "Profil",
  "Dein Name, dein Kiez und deine Einstellungen": "Ton nom, ton quartier et ta position",
  ...
  "Mit deiner Kiez-Auswahl bestimmst du für welche Gegenden du über neue Aktionen informiert werden willst.": " Avec ton choix de quartier tu définis les zones pour lesquelles tu souhaites être tenu informé de nouvelles actions.",
  "Deine Benachrichtigungen": "Tes messages",
  "Wie oft und aktuell willst du über neue Sammel-Aktionen in deinem Kiez informiert werden?": "Avec quelle régularité souhaites-tu être tenu informé des nouvelles actions de collectes dans ton quartier?",
  "Wie häufig möchtest du Infos über anstehende Aktionen bekommen?": "Avec quelle régularité souhaites-tu recevoir des Infos sur les futures actions?",
  "Diese App wurde von einem kleinen Team enthusiastischer IT-Aktivist*innen für die Deutsche Wohnen & Co. Enteignen - Kampagne entwickelt und steht unter einer freien Lizenz.\\n\\nWenn du Interesse daran hast diese App für dein Volksbegehren einzusetzen, dann schreib uns doch einfach eine Mail oder besuche uns auf unserer Webseite. So kannst du uns auch Fehler und Probleme mit der App melden.": "Cette appli a été développée par un petit groupe d'informaticien.ne.s activistes pour la campagne Deutsche Wohnen & Co. Enteignen - et se trouve sous licence libre.\\n\\n  Si tu es intéressé.e à utiliser cette appli pour un vote populaire, contactes nous simplement par email ou visite notre site web. Ainsi tu peux nous indiquer des erreurs ou dysfonctionnements encontrés avec l'appli.",
  "Heute, ": "Aujourd'hui, ",
  "Morgen, ": "Demain, ",
  "{prefix***REMOVED***{date***REMOVED*** um {zeit***REMOVED*** Uhr, ": "{prefix***REMOVED***{date***REMOVED*** à {zeit***REMOVED*** heure.s, ",
  "Aktionen konnten nicht geladen werden.": "Les actions n'ont pas pu être chargées.",
  ...
  "Aktion konnte nicht gespeichert werden.": "L'action na pas pu être sauvegardée.",
  ...
  "Möchtest du diese Aktion wirklich löschen?": "Souhaites-tu vraiment supprimer cette action?",
  "Ja": "Oui",
  "Nein": "Non",
  "Es scheint keine Internet-Verbindung zu bestehen.": "La connection Internet semble inexistante.",
  "Die Internet-Verbindung scheint sehr langsam zu sein.": "La connection Internet semble être très lente.",
  "Der Server antwortet leider nicht. Möglicherweise ist er überlastet, versuch es doch später nochmal": "Le serveur ne répond pas. Il est probablement surchargé, réessayes plus tard",
  "Ein Verbindungsproblem ist aufgetreten: ": "Une erreur de connection est survenue: ",
  "Der Server hat leider gerade technische Probleme: ": "Le serveur a malheureusement un problème technique: ",
  "Der Server reagiert nicht, obwohl eine Internet-Verbindung besteht. Vielleicht gibt es ein technisches Problem, bitte versuch es später nochmal. ": "Le serveur ne réagit pas, même si la connection Internet est établie. Peut être existe-t-il un problème technique, réessayes plus tard ",
  "Das Internet scheint nicht erreichbar zu sein: ": "Internet semble indisponible: ",
  "Es ist ein Fehler aufgetreten beim Verifizieren deines Benutzer*in-Accounts. Probiere es eventuell zu einem späteren Zeitpunkt noch einmal oder versuche die App nochmal neu zu installieren, wenn du keine eigenen Aktionen betreust.": "Une erreur est survenue lors de la vérification de ton compte. Réessayes plus tard ou essayes de réinstaller l'appli si tu n'est pas en charge d'actions.",
  "SSL-Zertifikat konnte nicht geladen werden": "Certificat-SSL n'a pas pu être chargé",
  "Deine App-Version ist veraltet. Dies ist die Version {version***REMOVED***, du musst aber mindestens Version {minClient***REMOVED*** benutzen, damit die App richtig funktioniert.": "Ta version de l'appli est dépassée. Celle-ci est la version {version***REMOVED***, mais c'est au moins la version {minClient***REMOVED*** que tu nécessites pour que l'appli fonctionne correctement.",
  "Falsches Format": "Format incorrect",
  "Listen-Orte konnten nicht geladen werden.": "La liste des lieux n'a pas pu être chargée.",
  "Teilnahmen und Absagen": "Participations et annulations",
  "Benachrichtigungen über Mitstreiter*innen bei Aktionen an denen du teilnimmst": "Messages par le biais d'autres militant.e.s pour les actions auxquelles tu participes ",
  "Änderungen an Aktionen": "Modification des actions",
  "Änderungen an Benachrichtigungen wenn sich Aktionen geändert haben oder abgesagt wurden an denen du teilnimmst": "Changement des messages lorsque les actions auxquelles tu participes ont changé ou ont été annulé ",
  "Aktionen-Chats": "Chat d'actions",
  "Benachrichtigungen über neue Chat-Nachrichten zu Aktionen an denen du teilnimmst": "Communication des actions auxquelles tu participes par le biais de nouveaux messages dans le chat ",
  "Infos": "Infos",
  "Allgemeine Infos": "Infos générales",
  "Nachricht von {name***REMOVED***": "Message de {name***REMOVED***",
  "Problem beim Einrichten von Push-Nachrichten": "Problème à installer les notifications-push",
  "Es konnte keine Verbindung zum Google-Push-Service hergestellt werden. Das kann der Fall sein, wenn etwa ein Google-freies Betriebssystem genutzt wird. Darum kann die App nur Benachrichtigungen empfangen während sie geöffnet ist.": "La connection au service Google-Push n'a pas pu être établie. Cela peut être le cas lorsque le système d'exploitation n'est pas de Google. Pour cette raison l'appli ne peut undrecevoir les notifications que lorsque l'appli est ouverte",
  "Beim Abrufen von Nachrichten ist ein Fehler aufgetreten. Das regelmäßige Abrufen von Nachrichten wird deshalb deaktiviert": "Une erreur est survenue lors du chargement des messages. Le chargement fréquent des messages sera donc désactivé",
  "Fehler beim Anmelden der Benachrichtigungen zu {topics***REMOVED***": "Erreur lors du chargement des messages pour {topics***REMOVED***",
  "Fehler beim Abmelden der Benachrichtigungen zu {topics***REMOVED***": "Erreur lors de l'annulation des messages pour {topics***REMOVED***",
  "Für Push-Nachrichten an Geräte muss mindestens ein Empfänger angegeben werden.": "Pour les notifications push sur les dispositifs, un déstinataire doit être au moins indiqué.",
  "Push-Nachricht an Geräte konnte nicht versandt werden": "Notification push vers les dispositifs n'a pas pu être envoyé",
  "Für Push-Nachrichten an Topics muss ein Topic angegeben werden.": "Pour les notifications push vers Topics, un Topic doit être indiqué.",
  "Push-Nachricht an Thema konnte nicht versandt werden": "Notification push vers Thème n’a pas pu être envoyé",
  "Für Push-Nachrichten an Aktionen muss die Aktions-ID angegeben werden.": "Pour les notifications push d’actions, l’identifiant de l’action doit être indiqué.",
  "Push-Nachricht an Aktion konnte nicht versandt werden.": "Notification push vers action n’a pas pu être envoyée.",
  ...
  "Eine neue Benutzer*in wird angelegt.": "Un.e nouve.au/lle utilisat.eur.trice est enregistrée.",
  "Anlegen einer neuen Benutzer*in ist gescheitert.": "Enregistrement d\'un.e nouve.au.lle utilisat.eur.trice a échoué.",
  "Benutzer*indaten konnte nicht überprüft werden.": "Données d’utilisat.eur.trice n’a pas pu être vérifiées.",
  "Benutzer*in-Name konnte nicht geändert werden.": "Nom d’utilisat.eur.trice n’a pas pu être modifié.",
  ...
  "Um diese Aktion auszuführen musst du dir einen Benutzer*in-Name geben": "Pour exécuter cette action définis d’abord un nom d’utilisat.eur.trice",
  "am {tage***REMOVED***,": "le {tage***REMOVED***,",
  "Auswählen": "Choisir",
  "Auswahl übernehmen": "Utiliser ce choix",
  "Das Volksbegehren lebt von deiner Beteiligung! \n": "Le vote populaire vit de ta participation! \n",
  "Wenn du keine passende Sammel-Aktion findest, dann lade doch andere zum gemeinsamen Sammeln ein. Andere können deinen Sammel-Aufruf sehen und teilnehmen. Du kannst die Aktion jederzeit bearbeiten oder wieder löschen.": "Si tu ne trouves pas d’action de collecte appropriée, invites d’autres personnes. Elles pourront voir ton appel à la collecte et y participer. Tu peux à tout moment modifier ou supprimer l’action ",
  "Kontakt": "Contact",
  "Hier kannst du ein paar Worte über dich verlieren, \nvor allem, wie man dich kontaktieren kann, damit andere sich mit dir zum Sammeln verabreden können. \nBeachte dass alle Sammler*innen deine Angaben lesen können.": "Ici, tu peux te présenter en quelques mots, \nsurtout comment il est possible de te contacter afin d’organiser une rencontre entre toi et d’autres membres pour la collecte . \nRemarque: tout.es les collect.eur.rice.s peuvent lire tes messages",
  "Beschreibung": "Déscription",
  "Gib eine kurze Beschreibung der Aktion an. Wo willst du sammeln gehen, was sollen die anderen Sammlerinnen und Sammler mitbringen? Kann man auch später dazustoßen, usw": "Décris brièvement l’action. Où veux-tu collecter, que doivent apporter les autres collect.eur.rice.s? Peut-on également joindre l’action plus tard? etc…",
  ...
  "Wer?": "Qui?",
  "News": "Actualités",
  "Neues vom Volksbegehren und der Kampagne": "Actualité du vote populaire et de la campagne",
  ...
  "Deine Rückmeldung hilft Deinem Kiez-Team, die effektivsten Sammelaktionen zu erkennen. Außerdem können andere Teams von euren Erfahrungen lernen.": "Ton retour aide l’équipe de quartier à reconnaître les actions les plus efficaces. D’autres équipes peuvent également apprendre de vos actions.",
  "Anzahl Deiner Unterschriften": "Nombre de tes signatures",
  "Wie viele Leute waren bei der Aktion dabei?": "Combien de personnes étaient présentes à l’action?",
  "Wie viele Unterschriften hast Du persönlich gesammelt?": "Combien de signatures as-tu collectées personnellement?",
  ...
  "mäßig": "moyen",
  "doof": "bof",
  "Wie viele Stunden habt ihr gesammelt?": "Durant combien d’heures avez-vous collecté?",
  "Wie viele Stunden warst Du sammeln?": "Combien d’heures as-Tu passé à collecter?",
  "Auf die nächste halbe Stunde gerundet": "En arrondissant à la demi-heure supérieure",
  ...
  "Optional: Sonstige Anmerkungen zu den Daten?": "Optionnel: autres remarques à propos des dates?",
  "Anmerkungen: ": "Remarques: ",
  "Optional: Muss man noch etwas zu den Angaben wissen?": "Optionnel: doit-on savoir quelque chose sur les indications?",
  "Wie war die Situation? (Wetter, Veranstaltung in der Nähe, besonderer Anlass, ...)": "Comment était la situation? (météo, activités dans les environs, occasion spéciale, ...)",
  "Situation: ": "Situation: ",
  ...
  ***REMOVED***,
  ...
  "Alle Daten, die du in die App eingibst werden ausschließlich auf Systemem der Deutsche Wohnen & Co. Enteignen - Kampagne gespeichert und nur für die App und die Kampagne verwendet. Beachte jedoch, dass viele Daten, die du eingibst von anderen Nutzer*innen der App gelesen werden können. Chat-Nachrichten sind ausschließlich lesbar für alle Teilnehmer*innen des Chats zum Zeitpunkt der Nachricht.\n\nFür die Funktion der Push-Nachrichten sind wir auf den Einsatz einer Zustell-Infrastruktur von Google und ggf. Apple angewiesen. Daten die auf diesem Weg transportiert werden, werden verschlüsselt übertragen. Wenn du möchtest, dass alle persönlichen Daten, die du eingetragen hast gelöscht werden, schreibe uns bitte eine Mail an e@mail.com.": "Toutes les données que tu inscris dans l’appli seront uniquement sauvegardées et utilisées sur les systèmes de la campagne -Deutsche Wohnen & Co. Enteignen-. Considères toutefois, que beaucoup de données que tu partages peuvent être lues par d’autres utilisat.eur.rice.s de l’appli. Les messages du chat sont seulement lisibles pour les participant.e.s du chat au moment de leur rédaction. \n\nConcernant la fonction des notifications push, nous sommes dépendants d’une structure de gestion Google ou Apple. Les données véhiculées par ce biais sont cryptées. Si tu souhaites que toutes les données que tu as partagées soient supprimées, écris nous un mail à e@mail.com",
  "Okay": "OK",
  "Zu viele Tage": "Trop de jours",
  "Bitte wähle {maxTage***REMOVED*** Tage oder weniger aus.": "Choisis s’il te plaît {maxTage***REMOVED*** journées ou moins.",
  "Alle Daten, die du in die App eingibst werden ausschließlich auf Systemem der Deutsche Wohnen & Co. Enteignen - Kampagne gespeichert und nur für die App und die Kampagne verwendet. Beachte jedoch, dass viele Daten, die du eingibst von anderen Nutzer*innen der App gelesen werden können. Chat-Nachrichten sind ausschließlich lesbar für alle Teilnehmer*innen des Chats zum Zeitpunkt der Nachricht.\n\nFür die Funktion der Push-Nachrichten sind wir auf den Einsatz einer Zustell-Infrastruktur von Google und ggf. Apple angewiesen. Daten die auf diesem Weg transportiert werden, werden verschlüsselt übertragen. Wenn du möchtest, dass alle persönlichen Daten, die du eingetragen hast gelöscht werden, schreibe uns bitte eine Mail an app@dwenteignen.de.": "Toutes les données que tu inscris dans l’appli seront uniquement sauvegardées et utilisées sur les systèmes de la campagne -Deutsche Wohnen & Co. Enteignen-. Considères toutefois, que beaucoup de données que tu partages peuvent être lues par d’autres utilisat.eur.rice.s de l’appli. Les messages du chat sont seulement lisibles pour les participant.e.s du chat au moment de leur rédaction. \n\nConcernant la fonction des notifications push, nous sommes dépendants d’une structure de gestion Google ou Apple. Les données véhiculées par ce biais sont cryptées. Si tu souhaites que toutes les données que tu as partagées soient supprimées, écris nous un mail à  app@dwenteignen.de.",
  "deutsch": "allemand",
  "englisch": "anglais",
  "": "",
  "Hier kannst du ein paar Worte über dich verlieren, vor allem, wie man dich kontaktieren kann, damit andere sich mit dir zum Sammeln verabreden können. Beachte dass alle Sammler*innen deine Angaben lesen können.": "Ici, tu peux te présenter en quelques mots et écrire comment il est possible de te contacter afin d’organiser une rencontre entre toi et d’autres membres pour la collecte. Remarque: tout.es les collect.eur.rice.s peuvent lire tes messages.",
  "Gib eine kurze Beschreibung der Aktion an. Wo willst du sammeln gehen, was sollen die anderen Sammler*innen mitbringen? Kann man auch später dazustoßen?": "Décris brièvement l’action. Où souhaites-tu collecter, que doivent apporter les autres collect.eur.rice.s? Peut-on joindre l’action plus tard?",
