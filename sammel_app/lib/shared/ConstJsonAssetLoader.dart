...
const Map<String, dynamic> fr = {
  ...
  "{kiez} in {bezirk}\n Treffpunkt: {treffpunkt}": "{kiez} dans {bezirk}\n Point de rencontre: {treffpunkt}",
  "Unlesbare Push-Nachricht (Teilnahme) empfangen: {message}": "Notification push illisible (Participation) reçue: {message}",
  ...
  "Deine App-Version ist veraltet. Dies ist die Version {version}, du musst aber mindestens Version {minClient} benutzen, damit die App richtig funktioniert.": "Ta version de l'appli est dépassée. Celle-ci est la version {version}, mais c'est au moins la version {minClient} que tu nécessites pour que l'appli fonctionne correctement.",
  ...
  "Fehler beim Anmelden der Benachrichtigungen zu {topics}": "Erreur lors du chargement des messages pour {topics}",
  "Fehler beim Abmelden der Benachrichtigungen zu {topics}": "Erreur lors de l'annulation des messages pour {topics}",
  ...
  "Bitte wähle {maxTage} Tage oder weniger aus.": "Choisis s’il te plaît {maxTage} journées ou moins.",
