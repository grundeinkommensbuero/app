...
const Map<String, dynamic> en = {
  ...
  "{kiez} in {bezirk}\n ⛒ Treffpunkt: {treffpunkt}": "{kiez} in {bezirk}\n ⛒ meeting point: {treffpunkt}",
  "Unlesbare Push-Nachricht (Teilnahme) empfangen: {message}": "Unreadable push notification (participation) received: {message}",
  ...
  "Deine App-Version ist veraltet. Dies ist die Version {version}, du musst aber mindestens Version {minClient} benutzen, damit die App richtig funktioniert.": "Your version of the app is out-of-date. This is version {version}. You need to use at {minClient} or later, for the app to work properly.",
  ...
  "Fehler beim Anmelden der Benachrichtigungen zu {topics}": "Error logging in to notifications about {topics}",
  "Fehler beim Abmelden der Benachrichtigungen zu {topics}": "Error logging out from notifications about {topics}",
