  ...
  group('serialisere', () {
    test('serialisiert Termin ohne Teilnehmer oder Details', () {
      expect(
          ...
          '"ort":{"bezirk":"Friedrichshain-Kreuzberg","kiez":"Frankfurter Allee Nord","lattitude":52.49653,"longitude":13.43762***REMOVED***,'
          '"typ":"Sammeln",'
          '"lattitude":52.52116,'
          '"longitude":13.41331,'
          '"participants":null,'
    ...
    ***REMOVED***);
    ...
    test('deserialisiert Termin mit Teilnehmer und Details', () {
      var termin = Termin.fromJson(jsonDecode('{'
          ...
          '"id":1,'
          '"ort":{"bezirk":"Friedrichshain-Kreuzberg","kiez":"Frankfurter Allee Nord"***REMOVED***,'
          '"typ":"Sammeln"***REMOVED***'));
