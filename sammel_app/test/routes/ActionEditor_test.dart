...
void main() {
  ...
  group('shows all data', () {
    ...
    testWidgets('Type dialog shows correct typ', (WidgetTester tester) async
    {
      ...
      action_data.setState(() {action_data.action.typ = TerminTestDaten.einTermin().typ; action_data.validateInput();});
      await tester.pump();
    ...
    testWidgets('Type dialog shows correct no typ', (WidgetTester tester) async
    {
      await show_action_editor(tester, termineSeiteWidget);
      ActionEditorState action_data = tester.state(find.byKey(Key('action editor')));
      action_data.setState(() {action_data.action.typ = ''; action_data.validateInput();});
      await tester.pump();
    ...
    testWidgets('Location dialog are correctly shown', (WidgetTester tester) async
    {
      ...
      when(stammdatenService.ladeOrte()).thenAnswer((_) async => [goerli()]);
      action_data.setState(() {action_data.action.ort = goerli();});
      await tester.pump();
    ...
    testWidgets('changing kontakt is correctly shown', (WidgetTester tester) async
    {
      await show_action_editor(tester, termineSeiteWidget);
      ActionEditorState action_data = tester.state(find.byKey(Key('action editor')));
      action_data.setState(() {action_data.action.terminDetails.kontakt = 'test1';});
      await tester.pump();
    ...
    testWidgets('changing treffpunkt is correctly shown', (WidgetTester tester) async
    {
      await show_action_editor(tester, termineSeiteWidget);
      ActionEditorState action_data = tester.state(find.byKey(Key('action editor')));
      action_data.setState(() {action_data.action.terminDetails.treffpunkt = 'test1';});
      await tester.pump();
    ...
    testWidgets('changing beschreibung is correctly shown', (WidgetTester tester) async
    {
      await show_action_editor(tester, termineSeiteWidget);
      ActionEditorState action_data = tester.state(find.byKey(Key('action editor')));
      action_data.setState(() {action_data.action.terminDetails.kommentar = 'test1';});
      await tester.pump();
    ...
    testWidgets('changing tage is correctly shown', (WidgetTester tester) async
    {
      await show_action_editor(tester, termineSeiteWidget);
      ActionEditorState action_data = tester.state(find.byKey(Key('action editor')));
      action_data.setState(() {action_data.action.tage = [DateTime(2019, 12, 1)];});
      await tester.pump();
    ...
    testWidgets('no tage selection is correctly shown', (WidgetTester tester) async
    {
      ...
      action_data.setState(() {action_data.action.tage = List<DateTime>(); action_data.validateInput();});
      await tester.pump();
    ...
    testWidgets('Termin adds a day if bis before von',
          ...
          action_data.action.bis = TimeOfDay(hour: 10, minute: 31); action_data.validateInput();});
