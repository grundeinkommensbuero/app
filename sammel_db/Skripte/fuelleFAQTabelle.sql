...
"teaser": [
    {"type": "text", "content": "Am 26. Februar ist Sammelbeginn."}}
],
"rest": [],
"order": 1.0,
"tags": ["Start","Beginn","Sammelphase"]}'
)
insert into FAQ (id, inhalt) values (2,
'{"titel": "Wie lange wird gesammelt?",
"teaser": [
    {"type": "text", "content": "Die Sammelphase geht vom 26. Februar bis 25. Juni 2021, also vier Monate. Dieser Zeitraum ist nicht verlängerbar."}}
],
"rest": [],
"order": 1.0,
"tags": ["Start","Beginn","Sammelphase"]}'
...
"teaser": [
    ...
    {"type": "text", "content": "''Erklärt eine zustimmungswillige Person, dass sie nicht schreiben kann, so ist die Eintragung von Amts wegen in einer amtlichen Auslegungsstelle oder im Bezirksamt unter Vermerk dieser Erklärung vorzunehmen''."},
    {"type": "text", "content": "Wahlberechtigt sind alle Berliner*innen mit deutschem Pass, die mindestens drei Monate in Berlin gemeldet und mindestens 18 Jahre alt sind. Die Unterschriften eines großen Teils der Einwohner*innen Berlins, werden also für ungültig erklärt. Das ist unserer Meinung nach höchst undemokratisch und ein politischer Skandal. Wir freuen uns jedoch über jede Unterstützung und finden es deshalb gut, wenn auch Personen unterschreiben, die nicht wahlberechtigt sind."},
    {"type": "paragraph"},
    {"type": "text", "content": "Eine Ausnahmeregelung gilt gemäß Wahlgesetz jedoch: "},
],
"rest": [],
"order": 5.0,
"tags": ["Start","Beginn","Sammelphase"]}'
