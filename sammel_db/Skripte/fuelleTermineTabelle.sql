...
INSERT INTO TerminDetails (termin_id, treffpunkt, kommentar, kontakt) VALUES (1, 'Weltzeituhr', 'wir stellen uns an die Ubhf-Eingänge. ihr erkennt mich an der DWE-Weste', 'kalle@revo.de');
INSERT INTO TerminDetails (termin_id, treffpunkt, kommentar, kontakt) VALUES (2, 'Friseurladen', 'Klemmbrett raus und los!', 'kalle@revo.de');
INSERT INTO TerminDetails (termin_id, treffpunkt, kommentar, kontakt) VALUES (3, 'Zeitungsviertel', 'kommt zahlreich!', 'rosa@spartakus.de');
INSERT INTO TerminDetails (termin_id, treffpunkt, kommentar, kontakt) VALUES (4, 'DGB-Haus, Raum 223', 'Ihr seid alle eingeladen. Lasst uns über die weitere Sammel-Strategie diskutieren.', 'info@dwenteignen.de');
