...
open class TermineRestResource {
    ...
    open fun getTermine(filter: TermineFilter?): Response {
        LOG.debug("Lade Aktionen mit Filter ${filter?.typen***REMOVED***, ${filter?.tage***REMOVED***, ${filter?.von***REMOVED***, ${filter?.bis***REMOVED***, ${filter?.orte***REMOVED***, ${filter?.nurEigene***REMOVED***")
